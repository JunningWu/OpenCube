 ...
 */
/*
   NOTICE: This file is auto-generated by configure (configure.ac). Do not edit this file
   directly. Rather, make your changes to the expatmm.h.in macro template.
*/
#ifndef _EXPATMM_EXPATMM_H
#define _EXPATMM_EXPATMM_H

#include "expatmm-libdef.h"
#include "ExpatXMLParser.h"
//#include "ExpatXMLFileParser.h"

#define EXPATMM_LIBRARY_MAJOR    1
#define EXPATMM_LIBRARY_MINOR    0
#define EXPATMM_LIBRARY_REVISION 0
#define EXPATMM_LIBRARY_VERSION  "1.0.0"

namespace expatmm {

  std::string EXPATMM_LIBEXPORT getExpatMMVersion(void);

};

#endif /* _EXPATMM_EXPATMM_H */

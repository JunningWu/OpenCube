 ...
 * the prev/next entries already!
 */
static inline void __list_add_rcu(struct list_head * new_elem,
 ...
 */
static inline void list_add_rcu(struct list_head *new_elem, struct list_head *head)
{
	__list_add_rcu(new_elem, head, head->next);
}
 ...
 * list_for_each_entry_rcu().
 */
static inline void list_add_tail_rcu(struct list_head *new_elem,
									 struct list_head *head)
{
	__list_add_rcu(new_elem, head->prev, head);
}
 ...
 */
static inline void list_replace_rcu(struct list_head *old, struct list_head *new_elem){

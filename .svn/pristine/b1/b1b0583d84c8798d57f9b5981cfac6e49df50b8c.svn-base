...
void Adaptive_Codebook_Search( Word16 txdtx_ctrl_var,Word16 *A, Word16 *Aq, Word16 *T_op,Word16 ana[],	Word16 &TO_out,	Word16 &gain_pit_out,Word16
*CN_excitation_gain,Word16 *ai_zero,Word16 *h1,Word16 *zero,Word16
*x,Word16 i_subfr,Word16 *res2,Word16 *exc,Word16 *error,Word16 *mem_err,Word16 *xn,Word16 *mem_w0,Word16
*y_1){

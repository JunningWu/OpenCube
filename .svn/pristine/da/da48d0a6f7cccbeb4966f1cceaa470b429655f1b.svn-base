...
function onPageLoad()
{
    ...
    fixupIEPNG("id1", "template_results_page_files/transparent.gif");
    fixupIEPNG("id2", "template_results_page_files/transparent.gif");
    fixupIEPNG("id8", "template_results_page_files/transparent.gif");
    fixupIEPNG("id9", "template_results_page_files/transparent.gif");
    return true;
}
